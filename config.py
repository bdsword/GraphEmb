...
compile_cmds = {
    'x86_64_O0': 'g++ -O0 -std=c++14 -w -o {output} {src}',
    'x86_64_O1': 'g++ -O1 -std=c++14 -w -o {output} {src}',
    'x86_64_O2': 'g++ -O2 -std=c++14 -w -o {output} {src}',
    'x86_64_O3': 'g++ -O3 -std=c++14 -w -o {output} {src}',
